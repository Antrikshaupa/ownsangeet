...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Use rotating hue to prevent color muddiness
      currentHue = (currentHue + 0.1) % 1.0;
      // Low saturation (0.4) and high value (1.0) for light pastel colors
      const c = HSVtoRGB(currentHue, 0.4, 1.0);
      // Use high brightness multiplier for light, soft colors
      c.r *= 0.65;
      c.g *= 0.65;
      c.b *= 0.65;
      return c;
